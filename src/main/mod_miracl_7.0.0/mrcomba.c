...
/*** MULTIPLY ***/      /* multiply a by b, result in c */
  ...
  s1=extra;
  extra=0;  
  pp1=(mr_large)a[0]*b[2];
  sum=pp1+s0;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(sum>>MIRACL);
  s1=(mr_small)sum;
  extra+=(mr_small)(sum>>MIRACL);
  pp1=(mr_large)a[1]*b[1];
  sum=pp1+s0;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(sum>>MIRACL);
  s1=(mr_small)sum;
  extra+=(mr_small)(sum>>MIRACL);
  pp1=(mr_large)a[2]*b[0];
  sum=pp1+s0;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(sum>>MIRACL);
  s1=(mr_small)sum;
  ...
  s1=extra;
  extra=0;  
  pp1=(mr_large)a[0]*b[3];
  sum=pp1+s0;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(sum>>MIRACL);
  s1=(mr_small)sum;
  extra+=(mr_small)(sum>>MIRACL);
  pp1=(mr_large)a[1]*b[2];
  sum=pp1+s0;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(sum>>MIRACL);
  s1=(mr_small)sum;
  extra+=(mr_small)(sum>>MIRACL);
  pp1=(mr_large)a[2]*b[1];
  sum=pp1+s0;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(sum>>MIRACL);
  s1=(mr_small)sum;
  extra+=(mr_small)(sum>>MIRACL);
  pp1=(mr_large)a[3]*b[0];
  sum=pp1+s0;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(sum>>MIRACL);
  s1=(mr_small)sum;
  ...
  s1=extra;
  extra=0;  
  pp1=(mr_large)a[0]*b[4];
  sum=pp1+s0;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(sum>>MIRACL);
  s1=(mr_small)sum;
  extra+=(mr_small)(sum>>MIRACL);
  pp1=(mr_large)a[1]*b[3];
  sum=pp1+s0;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(sum>>MIRACL);
  s1=(mr_small)sum;
  extra+=(mr_small)(sum>>MIRACL);
  pp1=(mr_large)a[2]*b[2];
  sum=pp1+s0;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(sum>>MIRACL);
  s1=(mr_small)sum;
  extra+=(mr_small)(sum>>MIRACL);
  pp1=(mr_large)a[3]*b[1];
  sum=pp1+s0;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(sum>>MIRACL);
  s1=(mr_small)sum;
  extra+=(mr_small)(sum>>MIRACL);
  pp1=(mr_large)a[4]*b[0];
  sum=pp1+s0;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(sum>>MIRACL);
  s1=(mr_small)sum;
  ...
  s1=extra;
  extra=0;  
  pp1=(mr_large)a[0]*b[5];
  sum=pp1+s0;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(sum>>MIRACL);
  s1=(mr_small)sum;
  extra+=(mr_small)(sum>>MIRACL);
  pp1=(mr_large)a[1]*b[4];
  sum=pp1+s0;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(sum>>MIRACL);
  s1=(mr_small)sum;
  extra+=(mr_small)(sum>>MIRACL);
  pp1=(mr_large)a[2]*b[3];
  sum=pp1+s0;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(sum>>MIRACL);
  s1=(mr_small)sum;
  extra+=(mr_small)(sum>>MIRACL);
  pp1=(mr_large)a[3]*b[2];
  sum=pp1+s0;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(sum>>MIRACL);
  s1=(mr_small)sum;
  extra+=(mr_small)(sum>>MIRACL);
  pp1=(mr_large)a[4]*b[1];
  sum=pp1+s0;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(sum>>MIRACL);
  s1=(mr_small)sum;
  extra+=(mr_small)(sum>>MIRACL);
  pp1=(mr_large)a[5]*b[0];
  sum=pp1+s0;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(sum>>MIRACL);
  s1=(mr_small)sum;
  ...
  s1=extra;
  extra=0;  
  pp1=(mr_large)a[1]*b[5];
  sum=pp1+s0;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(sum>>MIRACL);
  s1=(mr_small)sum;
  extra+=(mr_small)(sum>>MIRACL);
  pp1=(mr_large)a[2]*b[4];
  sum=pp1+s0;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(sum>>MIRACL);
  s1=(mr_small)sum;
  extra+=(mr_small)(sum>>MIRACL);
  pp1=(mr_large)a[3]*b[3];
  sum=pp1+s0;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(sum>>MIRACL);
  s1=(mr_small)sum;
  extra+=(mr_small)(sum>>MIRACL);
  pp1=(mr_large)a[4]*b[2];
  sum=pp1+s0;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(sum>>MIRACL);
  s1=(mr_small)sum;
  extra+=(mr_small)(sum>>MIRACL);
  pp1=(mr_large)a[5]*b[1];
  sum=pp1+s0;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(sum>>MIRACL);
  s1=(mr_small)sum;
  ...
  s1=extra;
  extra=0;  
  pp1=(mr_large)a[2]*b[5];
  sum=pp1+s0;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(sum>>MIRACL);
  s1=(mr_small)sum;
  extra+=(mr_small)(sum>>MIRACL);
  pp1=(mr_large)a[3]*b[4];
  sum=pp1+s0;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(sum>>MIRACL);
  s1=(mr_small)sum;
  extra+=(mr_small)(sum>>MIRACL);
  pp1=(mr_large)a[4]*b[3];
  sum=pp1+s0;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(sum>>MIRACL);
  s1=(mr_small)sum;
  extra+=(mr_small)(sum>>MIRACL);
  pp1=(mr_large)a[5]*b[2];
  sum=pp1+s0;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(sum>>MIRACL);
  s1=(mr_small)sum;
  ...
  s1=extra;
  extra=0;  
  pp1=(mr_large)a[3]*b[5];
  sum=pp1+s0;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(sum>>MIRACL);
  s1=(mr_small)sum;
  extra+=(mr_small)(sum>>MIRACL);
  pp1=(mr_large)a[4]*b[4];
  sum=pp1+s0;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(sum>>MIRACL);
  s1=(mr_small)sum;
  extra+=(mr_small)(sum>>MIRACL);
  pp1=(mr_large)a[5]*b[3];
  sum=pp1+s0;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(sum>>MIRACL);
  s1=(mr_small)sum;
  ...
  s1=extra;
  extra=0;  
  pp1=(mr_large)a[4]*b[5];
  sum=pp1+s0;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(sum>>MIRACL);
  s1=(mr_small)sum;
  extra+=(mr_small)(sum>>MIRACL);
  pp1=(mr_large)a[5]*b[4];
  sum=pp1+s0;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(sum>>MIRACL);
  s1=(mr_small)sum;
...
/*** SQUARE ***/    /* squares a, result in b */
  ...
  s1=extra;
  extra=0;
  pp1=(mr_large)a[0]*a[2];
  sum=(mr_large)s0+(mr_small)pp1+(mr_small)pp1;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(pp1>>MIRACL)+(pp1>>MIRACL)+(sum>>MIRACL);
  s1=(mr_small)sum;
  extra+=(mr_small)(sum>>MIRACL);
  pp1=(mr_large)a[1]*a[1]+s0;
  s0=(mr_small)pp1;
  pp1=(mr_large)s1+(pp1>>MIRACL);
  s1=(mr_small)pp1;
  extra+=(mr_small)(pp1>>MIRACL);
  ...
  s1=extra;
  extra=0;
  pp1=(mr_large)a[0]*a[3];
  sum=(mr_large)s0+(mr_small)pp1+(mr_small)pp1;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(pp1>>MIRACL)+(pp1>>MIRACL)+(sum>>MIRACL);
  s1=(mr_small)sum;
  extra+=(mr_small)(sum>>MIRACL);
  pp1=(mr_large)a[1]*a[2];
  sum=(mr_large)s0+(mr_small)pp1+(mr_small)pp1;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(pp1>>MIRACL)+(pp1>>MIRACL)+(sum>>MIRACL);
  s1=(mr_small)sum;
  ...
  s1=extra;
  extra=0;
  pp1=(mr_large)a[0]*a[4];
  sum=(mr_large)s0+(mr_small)pp1+(mr_small)pp1;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(pp1>>MIRACL)+(pp1>>MIRACL)+(sum>>MIRACL);
  s1=(mr_small)sum;
  extra+=(mr_small)(sum>>MIRACL);
  pp1=(mr_large)a[1]*a[3];
  sum=(mr_large)s0+(mr_small)pp1+(mr_small)pp1;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(pp1>>MIRACL)+(pp1>>MIRACL)+(sum>>MIRACL);
  s1=(mr_small)sum;
  extra+=(mr_small)(sum>>MIRACL);
  pp1=(mr_large)a[2]*a[2]+s0;
  s0=(mr_small)pp1;
  pp1=(mr_large)s1+(pp1>>MIRACL);
  s1=(mr_small)pp1;
  extra+=(mr_small)(pp1>>MIRACL);
  ...
  s1=extra;
  extra=0;
  pp1=(mr_large)a[0]*a[5];
  sum=(mr_large)s0+(mr_small)pp1+(mr_small)pp1;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(pp1>>MIRACL)+(pp1>>MIRACL)+(sum>>MIRACL);
  s1=(mr_small)sum;
  extra+=(mr_small)(sum>>MIRACL);
  pp1=(mr_large)a[1]*a[4];
  sum=(mr_large)s0+(mr_small)pp1+(mr_small)pp1;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(pp1>>MIRACL)+(pp1>>MIRACL)+(sum>>MIRACL);
  s1=(mr_small)sum;
  extra+=(mr_small)(sum>>MIRACL);
  pp1=(mr_large)a[2]*a[3];
  sum=(mr_large)s0+(mr_small)pp1+(mr_small)pp1;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(pp1>>MIRACL)+(pp1>>MIRACL)+(sum>>MIRACL);
  s1=(mr_small)sum;
  ...
  s1=extra;
  extra=0;
  pp1=(mr_large)a[1]*a[5];
  sum=(mr_large)s0+(mr_small)pp1+(mr_small)pp1;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(pp1>>MIRACL)+(pp1>>MIRACL)+(sum>>MIRACL);
  s1=(mr_small)sum;
  extra+=(mr_small)(sum>>MIRACL);
  pp1=(mr_large)a[2]*a[4];
  sum=(mr_large)s0+(mr_small)pp1+(mr_small)pp1;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(pp1>>MIRACL)+(pp1>>MIRACL)+(sum>>MIRACL);
  s1=(mr_small)sum;
  extra+=(mr_small)(sum>>MIRACL);
  pp1=(mr_large)a[3]*a[3]+s0;
  s0=(mr_small)pp1;
  pp1=(mr_large)s1+(pp1>>MIRACL);
  s1=(mr_small)pp1;
  extra+=(mr_small)(pp1>>MIRACL);
  ...
  s1=extra;
  extra=0;
  pp1=(mr_large)a[2]*a[5];
  sum=(mr_large)s0+(mr_small)pp1+(mr_small)pp1;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(pp1>>MIRACL)+(pp1>>MIRACL)+(sum>>MIRACL);
  s1=(mr_small)sum;
  extra+=(mr_small)(sum>>MIRACL);
  pp1=(mr_large)a[3]*a[4];
  sum=(mr_large)s0+(mr_small)pp1+(mr_small)pp1;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(pp1>>MIRACL)+(pp1>>MIRACL)+(sum>>MIRACL);
  s1=(mr_small)sum;
  ...
  s1=extra;
  extra=0;
  pp1=(mr_large)a[3]*a[5];
  sum=(mr_large)s0+(mr_small)pp1+(mr_small)pp1;
  s0=(mr_small)sum;
  sum=(mr_large)s1+(pp1>>MIRACL)+(pp1>>MIRACL)+(sum>>MIRACL);
  s1=(mr_small)sum;
  extra+=(mr_small)(sum>>MIRACL);
  pp1=(mr_large)a[4]*a[4]+s0;
  s0=(mr_small)pp1;
  pp1=(mr_large)s1+(pp1>>MIRACL);
  s1=(mr_small)pp1;
  extra+=(mr_small)(pp1>>MIRACL);
...
/*** PMULT ***/
  carry=0;
  u=(mr_large)a[0]*sn+carry;
  carry=(mr_small)(u>>MIRACL);
  b[0]=0;
  c[0]=(mr_small)u;
  u=(mr_large)a[1]*sn+carry;
  carry=(mr_small)(u>>MIRACL);
  b[1]=0;
  c[1]=(mr_small)u;
  u=(mr_large)a[2]*sn+carry;
  carry=(mr_small)(u>>MIRACL);
  b[2]=0;
  c[2]=(mr_small)u;
  u=(mr_large)a[3]*sn+carry;
  carry=(mr_small)(u>>MIRACL);
  b[3]=0;
  c[3]=(mr_small)u;
  u=(mr_large)a[4]*sn+carry;
  carry=(mr_small)(u>>MIRACL);
  b[4]=0;
  c[4]=(mr_small)u;
  u=(mr_large)a[5]*sn+carry;
  carry=(mr_small)(u>>MIRACL);
  b[5]=0;
  c[5]=(mr_small)u;
  u=(mr_large)carry*sn;
...
/*** INCREMENT ***/
  ...
  a[0]=(mr_small)u;
  carry=(mr_small)(u>>MIRACL);
  u=(mr_large)carry+a[1]+b[1];
  a[1]=(mr_small)u;
  carry=(mr_small)(u>>MIRACL);
  u=(mr_large)carry+a[2]+b[2];
  a[2]=(mr_small)u;
  carry=(mr_small)(u>>MIRACL);
  u=(mr_large)carry+a[3]+b[3];
  a[3]=(mr_small)u;
  carry=(mr_small)(u>>MIRACL);
  u=(mr_large)carry+a[4]+b[4];
  a[4]=(mr_small)u;
  carry=(mr_small)(u>>MIRACL);
  u=(mr_large)carry+a[5]+b[5];
  a[5]=(mr_small)u;
  carry=(mr_small)(u>>MIRACL);
    b=t->w;
...
/*** DECREMENT ***/	
  ...
  u=(mr_large)a[1]-b[1]-carry;
  a[1]=(mr_small)u;
  carry=0-(mr_small)(u>>MIRACL);
  u=(mr_large)a[2]-b[2]-carry;
  a[2]=(mr_small)u;
  carry=0-(mr_small)(u>>MIRACL);
  u=(mr_large)a[3]-b[3]-carry;
  a[3]=(mr_small)u;
  carry=0-(mr_small)(u>>MIRACL);
  u=(mr_large)a[4]-b[4]-carry;
  a[4]=(mr_small)u;
  carry=0-(mr_small)(u>>MIRACL);
  u=(mr_large)a[5]-b[5]-carry;
  a[5]=(mr_small)u;
  carry=0-(mr_small)(u>>MIRACL);
    }
...
/*** ADDITION2 ***/        /* add a and b, result in c */
  ...
  c[5]=(mr_small)u;
  carry=(mr_small)(u>>MIRACL);
  u=(mr_large)carry+a[6]+b[6];
  c[6]=(mr_small)u;
  carry=(mr_small)(u>>MIRACL);
  u=(mr_large)carry+a[7]+b[7];
  c[7]=(mr_small)u;
  carry=(mr_small)(u>>MIRACL);
  u=(mr_large)carry+a[8]+b[8];
  c[8]=(mr_small)u;
  carry=(mr_small)(u>>MIRACL);
  u=(mr_large)carry+a[9]+b[9];
  c[9]=(mr_small)u;
  carry=(mr_small)(u>>MIRACL);
  u=(mr_large)carry+a[10]+b[10];
  c[10]=(mr_small)u;
  carry=(mr_small)(u>>MIRACL);
  u=(mr_large)carry+a[11]+b[11];
  c[11]=(mr_small)u;
  carry=(mr_small)(u>>MIRACL);
    w->len=2*MR_COMBA;
...
/*** SUBTRACTION2 ***/
  ...
  c[5]=(mr_small)u;
  carry=0-(mr_small)(u>>MIRACL);
  u=(mr_large)a[6]-b[6]-carry;
  c[6]=(mr_small)u;
  carry=0-(mr_small)(u>>MIRACL);
  u=(mr_large)a[7]-b[7]-carry;
  c[7]=(mr_small)u;
  carry=0-(mr_small)(u>>MIRACL);
  u=(mr_large)a[8]-b[8]-carry;
  c[8]=(mr_small)u;
  carry=0-(mr_small)(u>>MIRACL);
  u=(mr_large)a[9]-b[9]-carry;
  c[9]=(mr_small)u;
  carry=0-(mr_small)(u>>MIRACL);
  u=(mr_large)a[10]-b[10]-carry;
  c[10]=(mr_small)u;
  carry=0-(mr_small)(u>>MIRACL);
  u=(mr_large)a[11]-b[11]-carry;
  c[11]=(mr_small)u;
  carry=0-(mr_small)(u>>MIRACL);
